...
const TRANSLATIONS = {
    en: {
        ...
        hero_subtitle: "For a day and a half you build a prototype of your own project alongside super-smart teenagers who live and breathe AI.",
        hero_subtitle_bold: "And you yourself, in turbo mode, cross several thresholds in mastering it.",
        ...
        cta_band_1: "Ready to cross several thresholds of AI mastery in turbo mode — in just 1.5 days?",
        cta_band_2: "Only 6 seats. Applying is the first step — we meet, then you decide.",
        ...
        dodo_band_eyebrow: "Official provider",
        dodo_band_title: "Dodo Pizza fuels the sprint 🍕",
        dodo_band_text: "Pizza and drinks from Dodo Pizza — fuel for the creativity of youth and entrepreneurs.",
    ...
    ru: {
        ...
        hero_subtitle: "Полтора дня вы собираете прототип своего проекта рядом с супер-умными подростками, для которых ИИ — родная стихия.",
        hero_subtitle_bold: "И сами, в турбо-режиме, проходите несколько порогов в его освоении.",
        ...
        cta_band_1: "Готовы за полтора дня в турбо-режиме пройти несколько порогов освоения ИИ?",
        cta_band_2: "Всего 6 мест. Заявка — первый шаг для знакомства и решения об участии.",
        ...
        dodo_band_eyebrow: "Официальный провайдер",
        dodo_band_title: "Dodo Pizza заправит спринт 🍕",
        dodo_band_text: "Пицца и напитки от Dodo Pizza — топливо для творчества молодёжи и предпринимателей.",
