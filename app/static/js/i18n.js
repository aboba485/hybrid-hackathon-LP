...
const TRANSLATIONS = {
    en: {
        ...
        cta_band_1: "Ready to turn your challenge into a working prototype in 1.5 days?",
        cta_band_2: "Only 6 seats. Applying commits you to nothing — we start with a conversation.",
    ...
    ru: {
        ...
        cta_band_1: "Готовы превратить свою задачу в рабочий прототип за полтора дня?",
        cta_band_2: "Всего 6 мест. Заявка ни к чему не обязывает — начнём со знакомства.",
